...
| **[Calbright Final Capstone](https://sites.google.com/d/1PXeOlJ5zg-bCf-zYpJPsbC8Xir6UZbiJ/p/14JE9aSd1oYWItacGBNrJzRxLORm6id_i/edit)** | Workforce Training   | SQL, Python, Excel                              | Designed a complete data analysis pipeline including data cleaning, transformation, and visualization to address real-world business challenges. Final project showcased via Google Sites. |
...
| **[AWS Flower Classifier](https://github.com/HildaPosada/aws)**                                                                          | Image Classification  | Python, PyTorch                      | Trained a deep learning model using transfer learning to classify 102 flower species and deployed a prediction interface using Python scripts. |
